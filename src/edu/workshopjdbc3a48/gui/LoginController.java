...
private  List<Utilisateur> l = null ;
    ...
    @FXML
    private ImageView show_mdp;
    @FXML
    private TextField mdp_t;
...
//logo.setImage(image);
if (pass_vis ==0)
{mdp_t.setVisible(false);
tf_mdp.setVisible(true);
}
else
{
mdp_t.setVisible(true);
...
private boolean compareImages(Mat image1, Mat image2) {
    ...
    private void Show(MouseEvent event) {
        ...
        mdp_t.setVisible(true);
tf_mdp.setVisible(false);
mdp_t.setText(tf_mdp.getText());
        }
        else if (pass_vis==1)
        {pass_vis=0;
        tf_mdp.setText(mdp_t.getText());
        mdp_t.setVisible(false);
tf_mdp.setVisible(true);}
    }
